...
{
    using cleanup::Range;
    EXPECT_FALSE(cleanup::checkAnyOverlap(std::make_pair(Range {2, 4}, Range {6, 8})));
    EXPECT_FALSE(cleanup::checkAnyOverlap(std::make_pair(Range {2, 3}, Range {4, 5})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {5, 7}, Range {7, 9})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {2, 8}, Range {3, 7})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {6, 6}, Range {4, 6})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {2, 6}, Range {4, 8})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {86, 88}, Range {79, 88})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {67, 83}, Range {68, 84})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {50, 83}, Range {82, 83})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {5, 47}, Range {5, 5})));
    EXPECT_TRUE(cleanup::checkAnyOverlap(std::make_pair(Range {78, 78}, Range {55, 79})));
